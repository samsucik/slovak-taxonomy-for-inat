...
if __name__ == "__main__":
    with open("checklist-of-lepidoptera-recorded-in-Slovakia-2022.txt", "r") as f:
        data = f.readlines()
    ...
    taxon_df.to_csv(
        "taxa-checklist-of-lepidoptera-recorded-in-Slovakia-2022.csv", index=False
    )

    taxon_df.to_json(
        "taxa-checklist-of-lepidoptera-recorded-in-Slovakia-2022.json",
        index=False,
        orient="records",
    )
