...
if __name__ == "__main__":
    with open("slovenske-mena-hmyzu.txt", "r") as f:
        data = f.readlines()
    ...
    taxon_df.to_csv("taxa-slovenske-mena-hmyzu.csv", index=False)

    taxon_df.to_json(
        "taxa-slovenske-mena-hmyzu.json",
        index=False,
        orient="records",
    )
